...
class Messagerie(customtkinter.CTk):
    def __init__(self):
      ...
      # ---- CURRENT CHANNEL  UNDER FRAME  - ROW 0    ---
        ...
        current_channel_label = customtkinter.CTkLabel(self.current_channel_frame, text="Channel actuel :", font=("Helvetica", 20))
        ...
        current_channel_title.grid(row=2, column=0, padx=20, pady=20)


      # ---- OLD MESSAGES UNDER FRAME  - ROW 1    ---
        
        self.old_messages_frame = customtkinter.CTkFrame(self.channel_frame)
        self.old_messages_frame.grid(row=1, column=0, padx=10, pady=(10, 0), sticky="ew", columnspan=2)
        self.old_messages_frame.grid_columnconfigure((0, 1), weight=1)

                # existant messages - checkboxe for each
        self.checkbox_1 = customtkinter.CTkCheckBox(self.old_messages_frame, text="message 1")
        self.checkbox_1.grid(row=1, column=0, padx=10, pady=(10, 0), sticky="w")
        self.checkbox_2 = customtkinter.CTkCheckBox(self.old_messages_frame, text="message 2")
        self.checkbox_2.grid(row=2, column=0, padx=10, pady=(10, 0), sticky="w")
        self.checkbox_3 = customtkinter.CTkCheckBox(self.old_messages_frame, text="message 3")
        self.checkbox_3.grid(row=1, column=1, padx=10, pady=(10, 0), sticky="w")
        self.checkbox_4 = customtkinter.CTkCheckBox(self.old_messages_frame, text="message 4")
