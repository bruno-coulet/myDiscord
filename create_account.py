...
frame.configure(fg_color="#0D2847", border_width=2, border_color=BORDER_COLOR)  # Couleur de fond du cadre
...
name_entry = ctk.CTkEntry(master=frame, placeholder_text="Name", fg_color="transparent", text_color="#C2E6FF", border_color="#3E63DD", placeholder_text_color="#C2E6FF", font=FONT)
name_entry.pack(pady=12, padx=10)

firstname_entry = ctk.CTkEntry(master=frame, placeholder_text="Firstname", fg_color="transparent", text_color="#C2E6FF", border_color="#3E63DD", placeholder_text_color="#C2E6FF", font=FONT)
firstname_entry.pack(pady=12, padx=10)

email_entry = ctk.CTkEntry(master=frame, placeholder_text="Email", fg_color="transparent", text_color="#C2E6FF", border_color="#3E63DD", placeholder_text_color="#C2E6FF", font=FONT)
email_entry.pack(pady=12, padx=10)

password_entry = ctk.CTkEntry(master=frame, placeholder_text="Password", fg_color="transparent", text_color="#C2E6FF", border_color="#3E63DD", placeholder_text_color="#C2E6FF", show="*", font=FONT)
...
create_label = ctk.CTkLabel(master=button_frame, text='Create', bg_color="#0D2847", font=FONT, text_color=TEXT_COLOR, cursor="hand2", padx=10)
...
back_to_login_label = ctk.CTkLabel(master=button_frame, text='Back to login', bg_color="#0D2847", font=FONT, text_color=TEXT_COLOR, cursor="hand2", padx=10)
